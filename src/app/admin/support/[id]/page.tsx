              ...
              <div className="bg-white text-gray-900 rounded-lg shadow flex flex-col">
                ...
                <div className="p-4 border-t">
                  <div className="flex gap-2">
                    <input value={outgoing} onChange={(e) => setOutgoing(e.target.value)} className="flex-1 border rounded px-3 py-2 bg-white text-gray-900 placeholder:text-gray-500" placeholder="Reply..."/>
