...
export default function MyExams() {
  ...
  return (
    <div>
      ...
      {activeTab === 'pending' && (
        <div className="space-y-4">
          <div className="bg-white/50 backdrop-blur-sm rounded-xl p-6 flex items-center justify-between">
            <p className="text-gray-600 text-center">No pending exams yet.</p>
      ...
      {activeTab === 'history' && (
        <div className="space-y-4">
          <div className="bg-white/50 backdrop-blur-sm rounded-xl p-6 flex items-center justify-center">
            <p className="text-gray-600 text-center">No exam history yet.</p>
            {/* <div className="flex items-center space-x-4">
      ...
      {activeTab === 'results' && (
        <div className="space-y-4">
          <div className="bg-white/50 backdrop-blur-sm rounded-xl p-6 flex items-center justify-center">
            <p className="text-gray-600 text-center">No exam results yet.</p>
          </div>
