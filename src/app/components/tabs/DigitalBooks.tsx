...
const DigitalBooks = () => {
  ...
  const BookPage = ({ book }: { book: Book }) => (
    <div className="max-w-4xl mx-auto p-6 relative">
      ...
      <div className="bg-white text-gray-900 rounded-lg shadow-lg p-8 relative">
      ...
      {selectedWord && (
        <div className="absolute inset-0 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center z-50">
          <div className="bg-white text-gray-900 rounded-xl p-6 max-w-md w-full mx-4 shadow-2xl border border-gray-200">
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {books.map((book) => (
            <div
              key={book.id}
              className="bg-white text-gray-900 rounded-lg shadow-lg overflow-hidden cursor-pointer transform hover:scale-105 transition-transform duration-200"
      ...
      <div className="bg-white text-gray-900 rounded-lg shadow-lg p-6">
        ...
        <div className="mb-6">
          <input
            ...
            className="w-full p-3 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder:text-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
        </div>
