...
export default function SupportChatWidget() {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed bottom-24 right-2 z-50 w-96 max-w-[95vw] bg-white text-neutral-900 rounded-xl shadow-2xl border border-neutral-200">
            ...
            <div className="p-4 space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full border rounded px-3 py-2 bg-white text-neutral-900 placeholder:text-neutral-500 focus:outline-none focus:ring focus:ring-blue-200"
                />
              </div>
              <div>
                  ...
                  <div className="p-3 border-t">
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 border rounded px-3 py-2 bg-white text-neutral-900 placeholder:text-neutral-500 focus:outline-none focus:ring focus:ring-blue-200"
                      />
