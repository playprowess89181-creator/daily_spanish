              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      className="w-full px-4 py-3 rounded-xl outline-none border-2 border-gray-200 bg-white/80 text-gray-900 placeholder:text-gray-500 backdrop-blur-sm focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition-all duration-200"
                      id="name"
                      name="name"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        className="w-full px-4 py-3 pr-10 rounded-xl outline-none border-2 border-gray-200 bg-white/80 text-gray-900 backdrop-blur-sm appearance-none focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition-all duration-200"
                        id="country"
                        name="country"
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 pr-12 rounded-xl outline-none border-2 border-gray-200 bg-white/80 text-gray-900 placeholder:text-gray-500 backdrop-blur-sm focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition-all duration-200"
                      id="password"
                      name="password"
                      placeholder="••••••••"
