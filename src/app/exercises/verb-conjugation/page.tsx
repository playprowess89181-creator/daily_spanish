          ...
          <div className="max-w-md mx-auto">
            <div className="flex items-center space-x-4">
              ...
              <input
                ...
                disabled={showResult}
                className="flex-1 px-4 py-3 border-2 border-gray-300 rounded-xl bg-white text-gray-900 placeholder:text-gray-500 text-lg font-semibold text-center focus:border-green-500 focus:outline-none disabled:bg-gray-100"
